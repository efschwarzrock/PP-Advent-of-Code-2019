	...
	while(!done){
		if(fgets(strcmd, 30, stdin) == NULL){
   			...
   			if(strcmp(strcmd, "n\n") == 0){
				...
				strcpy(strcmd, "south\n");
			}else if(strcmp(strcmd, "e\n") == 0){
				strcpy(strcmd, "east\n");
			}else if(strcmp(strcmd, "w\n") == 0){
				strcpy(strcmd, "west\n");
			}else{
